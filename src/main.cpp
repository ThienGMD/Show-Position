    ...
    void postUpdate(float dt) {
        ...
        if (m_fields->m_posLabel && m_player1) {
            ...
            if (g_showPosition) {
                ...
                // Cập nhật vị trí và độ mờ liên tục mỗi frame
...
// 2. Thêm Checkbox và nút Copy vào PauseLayer (Đã trả về đúng vị trí cũ)
class $modify(PosPauseLayer, PauseLayer) {
    void customSetup() {
        ...
        copyBtn->setPosition(ccp(35.f, 65.f)); // Vị trí gốc
